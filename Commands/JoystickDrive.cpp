...
void JoystickDrive::Execute() {
	Joystick * stick1 = Robot::oi->getJoystick1();
	//double speed = stick1->GetRawAxis(Joystick::kDefaultYAxis);
	//Robot::driveTrain->SetSpeed(speed);
	Robot::driveTrain->GetDrive()->ArcadeDrive(stick1,Joystick::kDefaultYAxis,stick1,Joystick::kDefaultTwistAxis);
}
